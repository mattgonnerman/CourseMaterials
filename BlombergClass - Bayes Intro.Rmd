...
At this point we have our model and we have simulated data, so we can finally learn how to actually run our model. While there are many Bayesian options for running models, by far the most common is Markov Chain Monte Carlo simulations. [Bayesian Inference is just counting]

[Simulated draws from the posterior]

[Samplers] [JAGS Sampling Approaches]
...
#### Data Packaging
There is not a singluar [Lists] [Vectors] [Matrices] [Arrays]
