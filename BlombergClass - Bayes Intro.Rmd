...
### Outline:
[This Lesson...]  
[Major Concepts in Bayesian Stats]
...
For those familiar with Maximum Likelihood Estimation, the likelihood of Bayes Theorem functions very similarly to the likelihood of an MLE. It links unobserved parameters with known information to find the most likely values of $\theta$ given observed values for *y*.   

**Prior Distribution** - $Pr(\theta)$  
The prior distribution represents any information we have about $\theta$ prior to collecting data. 
